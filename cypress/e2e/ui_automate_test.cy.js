...
describe('add property', () => {
  it('add property multiple rentable', () => {
    ...
    //generate unique id for test
      ...
      //this address is for validation, for some reason when validate, address have duplicate value
      ...
      cy.get('div[data-file-name=\'multiple-unit.svg\'', { timeout: 10000 }).click()
